...
namespace Automation.Tag.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260818012044_TagProject")]
    partial class TagProject
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Automation.Tag.Domain.Entities.TagGroup", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ProjectId", "Scope", "Name")
                        .IsUnique();

                    b.ToTable("TagGroups", "tag");
                });
            ...
            modelBuilder.Entity("Automation.Tag.Domain.Entities.TagItem", b =>
                {
                    b.HasOne("Automation.Tag.Domain.Entities.TagGroup", "TagGroup")
                        .WithMany()
